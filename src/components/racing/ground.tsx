...
export function Ground() {
  const gridMap = useTexture('/textures/car-racing/grid.png')
  const aoMap = useTexture('/textures/car-racing/ground-ao.png')
  const alphaMap = useTexture('/textures/car-racing/alpha-map.png')
